...
Just please check link:handbookInstallation.html[Installation and Quick Start Manual] for its installation.
...
Check a link:walkingThroughExamples.html[Walking through Examples] for a use case scenario of `commandunit` to learn how you can use it.
